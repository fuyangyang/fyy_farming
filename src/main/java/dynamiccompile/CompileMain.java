...
class CompilerMain {
    ...
    public static void testCompiler() throws Exception {
        ...
        // 將源码写入文件中
        String src = "package dynamiccompile;"
                + "public class TestCompiler {"
                + " public void disply() {"
                + " System.out.println(\"Hello\");"
                + "}}";
        String filename = currentDir + "/src/main/java/dynamiccompile/TestCompiler.java";
        ...
        Class<?> c = cLoader.loadClass("dynamiccompile.TestCompiler");
        cLoader.close();
        // 利用class创建实例，反射执行方法
